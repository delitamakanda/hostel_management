...
## Project Overview
- Django 6.0 project with apps `booking` providing HTML views and a small DRF API (see `booking/views.py`).
...
## Environment & Tooling
- Use Python 3.13+ (the CI currently targets Django 6.2 and compatible tooling).
